...
if [ -f "/Users/taemyung/go/bin/moai" ]; then
	exec "/Users/taemyung/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/taemyung/.local/bin/moai" ]; then
	exec "/Users/taemyung/.local/bin/moai" statusline < "$temp_file"
fi
